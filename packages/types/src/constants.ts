 ...
 */
export const PHASE1_COMPONENT_TYPES = ['Box', 'Row', 'Column', 'Text', 'Image'] as const;
 ...
 */
export const DANGEROUS_CSS_FUNCTIONS = ['calc(', 'var(', 'url(', 'env(', 'expression('] as const;
 ...
 */
export const PROTOTYPE_POLLUTION_SEGMENTS = ['__proto__', 'constructor', 'prototype'] as const;
